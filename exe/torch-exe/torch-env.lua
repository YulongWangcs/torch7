...
if not home or not paths.dirp(home) then home = os.getenv('HOMEPATH') end
if not home or not paths.dirp(home) then home = '.' end
...
local localinstalldir = paths.concat(home,'.luarocks')
if paths.dirp(localinstalldir) then
